...
public class EmployeeMapDemo3 {
    public static void main(String[] args) {

        /* Get the Employee List*/
        List<Employee> empList = EmployeeUtil.getEmployeeList();

        Function<Employee,Double> twiceSalaryOfEmp=(x)->x.getSalary()*2;

        List<Double> filteredEmpNames=empList.stream()
                .map(twiceSalaryOfEmp)
                .collect(Collectors.toList());

        System.out.println("##################### Initial Employee's Data ##################### ");
